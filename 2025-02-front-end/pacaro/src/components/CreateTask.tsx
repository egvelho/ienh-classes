...
export function CreateTask(props: CreateTaskProps) {
  ...
  return (
    <div className="m-8">
      <Card>
        <h2 className="text-center text-2xl font-extrabold mb-2 text-shadow-lg text-shadow-orange-600">
          Criar tarefa
        </h2>
        <form className="flex flex-col gap-2" onSubmit={quandoEnvia}>
          <input
            ...
            className="border-2 border-slate-700 rounded-lg p-2 outline-none focus:border-orange-600"
            value={title}
          ...
          <textarea
            ...
            className="border-2 border-slate-700 rounded-lg p-2 outline-none focus:border-orange-600 resize-none"
          ></textarea>
          ...
          <button
            type="submit"
            className="bg-orange-600 p-3 rounded-2xl text-white font-extrabold uppercase text-lg shadow-xl hover:cursor-pointer hover:bg-slate-700"
          >
            Enviar
          </button>
        </form>
